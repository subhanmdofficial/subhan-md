...
const QUOTE_URLS = [
    'https://raw.githubusercontent.com/ᴍ sᴜʙʜᴀɴ ᴀʟɪ/Islamic-Database/main/text/random_quotes.txt',
    'https://raw.githubusercontent.com/ᴍ sᴜʙʜᴀɴ ᴀʟɪ/Islamic-Database/main/text/motivational_quotes.txt',
    'https://raw.githubusercontent.com/ᴍ sᴜʙʜᴀɴ ᴀʟɪ/Islamic-Database/main/text/pickup_quotes.txt'
];
let cachedQuotes = [];
let lastFetchTime = 0;
...
async function fetchQuotes() {
    try {
        ...
        if (allQuotes.length === 0) {
            ...
            return [
                '💎 By 𝐒ᴜʙʜᴀɴ-𝐌ᴅ - Your WhatsApp Bot',
        ...
        return cachedQuotes.length > 0 ? cachedQuotes : ['💎 By 𝐒ᴜʙʜᴀɴ-𝐌ᴅ - Your WhatsApp Bot'];
    }
}
